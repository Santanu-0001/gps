...
public class travel_summary extends Activity {  
    ...
    public void onCreate(Bundle icicle) {  
        ...
        this.setContentView(R.layout.travel_summary1);
        ...
        adapter.addSection("Security", new SimpleAdapter(this, security, R.layout.travel_summary,  
            new String[] { ITEM_TITLE, ITEM_CAPTION }, new int[] { R.id.list_complex_title, R.id.list_complex_caption }));  
        
        //ListView list = new ListView(this);
        ListView list = (ListView)findViewById(R.id.list12);
        
//        list.setBackgroundResource(R.drawable.mobilebg2);
//        list.setDrawingCacheEnabled(true);
        
//        list.setCacheColorHint(R.color.transparent);
        list.setAdapter(adapter);
//        list.setDrawingCacheBackgroundColor(R.color.transparent);
//        list.setCacheColorHint(R.color.transparent);
